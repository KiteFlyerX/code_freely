...
# 第一步：创建 QApplication（必须在任何 Qt 导入之前）
...
# 第三步：延迟导入 GUI 组件
# 直接在这里创建所有组件，避免通过 import 触发模块级代码
...
class SimpleMainWindow(FluentWindow):
    ...
    def __init__(self):
        ...
        # 添加到导航
        self.addSubInterface(self.chat_view, FluentIcon.CHAT, "AI 对话")
        ...
        self.addSubInterface(self.knowledge_view, FluentIcon.DOCUMENT, "知识库")
