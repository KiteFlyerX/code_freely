...
class ProviderManager:
    ...
    def get_ccswitch_active_provider(self) -> Optional[ProviderConfig]:
        """
        从 cc-switch 获取当前活跃的提供商配置

        Returns:
            ProviderConfig: 当前活跃的提供商配置，如果获取失败则返回 None
        """
        import sqlite3
        from pathlib import Path
        import os
        ...
        try:
            ...
            # 超时设置
            timeout = int(env.get("API_TIMEOUT_MS", "300000")) // 1000  # 转换为秒
            ...
            print(f"从 cc-switch 获取活跃提供商失败: {e}")
            return None
